<div class="card mb-3">
    <div class="row g-0">
        <div class="col-md-4">
            ...
            <img id="showGoods" name="showGoods" src="product_img/<?php echo $imgList['img_file']; ?>"
                class="img-fluid rounded-start" alt="<?php echo $data['p_name']; ?>"
                title="<?php echo $data['p_name']; ?>">
            <div class="row mt-2">
                <?php do { ?>
                    <div class="col-md-4"><a href="product_img/<?php echo $imgList['img_file']; ?>" rel="group"
                            class="fancybox" title="<?php echo $data['p_name']; ?>"><img
                                src="product_img/<?php echo $imgList['img_file']; ?>" alt="<?php echo $data['p_name']; ?>"
                                title="<?php echo $data['p_name']; ?>" class="img-fluid"></a></div>
        ...
        <div class="col-md-8">
            <div class="card-body">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        <button type="button" name="button01" id="button01" class="btn btn-success btn-lg color-success"
